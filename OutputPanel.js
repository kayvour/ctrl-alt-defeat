function OutputPanel({ responses }) {
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8 w-full max-w-5xl mt-12 px-4">
      {/* Sith panel */}
      <article className="backdrop-blur-sm bg-gray-900/70 ring-2 ring-red-700 rounded-2xl p-6 shadow-xl hover:shadow-red-600/60 transition">
      ...
      {/* Jedi panel */}
      <article className="backdrop-blur-sm bg-gray-900/70 ring-2 ring-cyan-400 rounded-2xl p-6 shadow-xl hover:shadow-cyan-400/60 transition">
